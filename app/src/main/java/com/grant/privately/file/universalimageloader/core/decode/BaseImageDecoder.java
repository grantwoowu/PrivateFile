 ...
 *******************************************************************************/
package com.grant.privately.file.universalimageloader.core.decode;
...
public class BaseImageDecoder implements ImageDecoder {
	 ...
	 *                       cn.iclap.postil.opensource.universalimageloader.core.ImageLoaderConfiguration.Builder#writeDebugLogs()
	...
	private boolean canDefineExifParams(String imageUri, String mimeType) {
		return "image/jpeg".equalsIgnoreCase(mimeType) && (Scheme.ofUri(imageUri) == ImageDownloader.Scheme.FILE);
	}
