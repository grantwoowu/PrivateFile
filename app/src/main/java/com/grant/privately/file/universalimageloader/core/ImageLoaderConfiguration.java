 ...
 *******************************************************************************/
package com.grant.privately.file.universalimageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.grant.privately.file.universalimageloader.cache.disc.DiskCache;
import com.grant.privately.file.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.grant.privately.file.universalimageloader.cache.memory.MemoryCache;
import com.grant.privately.file.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.grant.privately.file.universalimageloader.core.assist.FlushedInputStream;
import com.grant.privately.file.universalimageloader.core.assist.ImageSize;
import com.grant.privately.file.universalimageloader.core.assist.QueueProcessingType;
import com.grant.privately.file.universalimageloader.core.decode.ImageDecoder;
import com.grant.privately.file.universalimageloader.core.download.ImageDownloader;
import com.grant.privately.file.universalimageloader.core.process.BitmapProcessor;
import com.grant.privately.file.universalimageloader.utils.L;
import com.grant.privately.file.universalimageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link cn.iclap.postil.opensource.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, cn.iclap.postil.opensource.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link cn.iclap.postil.opensource.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link cn.iclap.postil.opensource.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link cn.iclap.postil.opensource.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(cn.iclap.postil.opensource.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link cn.iclap.postil.opensource.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(cn.iclap.postil.opensource.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link cn.iclap.postil.opensource.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link cn.iclap.postil.opensource.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link cn.iclap.postil.opensource.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link cn.iclap.postil.opensource.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link cn.iclap.postil.opensource.universalimageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link cn.iclap.postil.opensource.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
