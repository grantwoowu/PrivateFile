...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain cn.iclap.postil.opensource.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
